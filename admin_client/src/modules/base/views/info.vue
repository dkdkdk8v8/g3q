	...
	<div class="view-my">
		...
		<el-form label-width="100px" :model="form" :disabled="loading">
			<el-form-item label="头像">
				<cl-upload-space v-model="form.headImg" />
			</el-form-item>
			...
			<el-form-item label="原密码">
				<el-input v-model="form.oldPassword" type="password" placeholder="请填写原密码" clearable />
			</el-form-item>

			<el-form-item label="新密码">
				<el-input v-model="form.password" type="password" placeholder="请填写新密码" clearable />
			</el-form-item>
