	...
	<cl-view-group ref="ViewGroup">
		...
		<template #right>
			<cl-crud ref="Crud">
				...
				<cl-row>
					<!-- 数据表格 -->
					<cl-table size="small" ref="Table" row-key="id" @row-click="onRowClick">
...
const Table = useTable({
	...
	columns: [
		...
		{ label: "名称", prop: "name", align: "left", minWidth: 140 },
		{ label: "值", prop: "value", minWidth: 140, showOverflowTooltip: true },
		{ label: "排序", prop: "orderNum", sortable: "desc", width: 80, fixed: "right" },
		{ label: "备注", prop: "remark", showOverflowTooltip: true, minWidth: 140 },
