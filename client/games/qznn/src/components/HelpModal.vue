        ...
        <div class="modal-content help-modal" @click.stop>
            ...
            <div class="help-content">
                ...
                <section v-if="mode === 0">
                    ...
                    <p>• <b>发牌阶段：</b>投注结束后，系统会发出5张牌给各玩家。</p>
                    <p>• <b>拼点阶段：</b>所有手牌发完后，玩家可以计算自己的牌型，并选择摊牌。</p>
                ...
                <section v-else-if="mode === 1">
                    ...
                    <p>• <b>发牌阶段：</b>游戏开始，系统会发给所有玩家三张手牌，并先翻开给玩家看。翻开的三张牌只有玩家自己能看见，无法看见其他人的三张牌。</p>
                    <p>• <b>抢庄阶段：</b>发牌结束后，进入抢庄阶段；玩家可以选择“1倍”、“2倍”、“3倍”、“4倍”、“不抢”。抢庄倍数最高的玩家做庄。若多名玩家抢庄最高倍数相同，则携带金币越多的玩家坐庄几率越大，如果所有玩家都不叫分，则系统随机选择一个玩家作为庄家，倍率默认为“1倍”。
                    </p>
                    <p>• <b>加倍阶段：</b>确定庄家后，闲家可以选择“1倍”、“5倍”、“10倍”、“15倍”、“20倍”倍率进行加倍。不选则默认以最小的“1倍”进行加倍。</p>
                    <p>• <b>补牌阶段：</b>投注结束后，系统会发出最后2张牌给各玩家。</p>
                    <p>• <b>拼点阶段：</b>所有手牌发完后，玩家可以计算自己的牌型，并选择摊牌。</p>
                    <p>• <b>比牌阶段：</b>每位闲家分别和庄家比较大小，闲家和闲家之间不进行比较。</p>
                </section>
                ...
                <section v-else-if="mode === 2">
                    ...
                    <p>• <b>发牌阶段：</b>游戏开始，系统会发给所有玩家四张手牌，并先翻开给玩家看。翻开的四张牌只有玩家自己能看见，无法看见其他人的四张牌。</p>
                    <p>• <b>抢庄阶段：</b>牌结束后，进入抢庄阶段；玩家可以选择“1倍”、“2倍”、“3倍”、“4倍”、“不抢”。抢庄倍数最高的玩家做庄。若多名玩家抢庄最高倍数相同，则携带金币越多的玩家坐庄几率越大，如果所有玩家都不叫分，则系统随机选择一个玩家作为庄家，倍率默认为“1倍”。
                    </p>
                    <p>• <b>加倍阶段：</b>确定庄家后，闲家可以选择“1倍”、“5倍”、“10倍”、“15倍”、“20倍”倍率进行加倍。不选则默认以最小的“1倍”进行加倍。</p>
                    <p>• <b>补牌阶段：</b>投注结束后，系统会发出最后1张牌给各玩家。</p>
                    <p>• <b>拼点阶段：</b>所有手牌发完后，玩家可以计算自己的牌型，并选择摊牌。</p>
                    <p>• <b>比牌阶段：</b>每位闲家分别和庄家比较大小，闲家和闲家之间不进行比较。</p>
                </section>
                ...
                <section>
                    ...
                    <p>• 在每局游戏中获胜后，系统会收取本局总赢钱金额的5%作为平台服务费。</p>
