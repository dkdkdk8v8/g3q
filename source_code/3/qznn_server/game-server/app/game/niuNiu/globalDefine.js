...
gDefine.PAI_XING = {
    ...
    CowSilver:  {weight:0x000B, times:5, name:"银牛"},
    CowFace: 	{weight:0x000C, times:6, name:"五花牛"},
    CowBoom:   {weight:0x000D, times:8, name:"炸弹"},
    CowLittle: {weight:0x000E, times:10, name:"五小牛"}
};
